...
import { LayoutDashboard, FolderKanban, ListTodo, Users, LogOut } from 'lucide-react';
...
export default function Sidebar() {
    ...
    const navItems = [
        ...
        { href: '/superadmin/project-management', label: 'Project Management', icon: FolderKanban },
        { href: '/superadmin/task-management', label: 'Task Management', icon: ListTodo },
    ...
    return (
        <aside className="w-64 h-full bg-white shadow-lg p-6 space-y-6 animate-in slide-in-from-left duration-500">
            <h2 className="text-2xl font-bold text-slate-900">TaskMind Admin</h2>
